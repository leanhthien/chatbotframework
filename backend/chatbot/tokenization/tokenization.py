...
class LongMatchingTokenizer(BaseTokenizer):
    def __init__(self, bi_grams_path='./chatbot/tokenization/bi_grams.txt', tri_grams_path='./chatbot/tokenization/tri_grams.txt'):
        """
        Initial config
...
def test():
    ...
    tokens = lm_tokenizer.tokenize(u'Thuế thu nhập')
    print(tokens)
